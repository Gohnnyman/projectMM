...
// chip). The driver (src/light/drivers/I80Peripheral.h) pre-encodes the WHOLE frame into one
...
// (src/light/drivers/MoonI80Peripheral.h) is the same CRTP sibling with its forwards re-pointed.
