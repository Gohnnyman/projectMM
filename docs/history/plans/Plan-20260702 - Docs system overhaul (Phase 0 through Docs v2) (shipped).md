...
[folder-structure decision](../../backlog/folder-structure-proposal.md)).
...
- **assets/ and test/ type-splits** — the [folder-structure decision](../../backlog/folder-structure-proposal.md)'s
