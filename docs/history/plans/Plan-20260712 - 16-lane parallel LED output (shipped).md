...
- **Not** a direct-register LCD_CAM driver (rejected: one-pin gain for the most IDF-bump-sensitive file in the tree). **Not** >16 lanes (S3 hardware-capped at 16; P4-RGB-panel 24-lane is a separate future backlog item).
