...
The feasibility research is [`docs/backlog/shift-register-driver-analysis.md`](../../backlog/shift-register-driver-analysis.md). The two facts that shape this plan:
