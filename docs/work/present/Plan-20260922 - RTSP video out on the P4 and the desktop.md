...
HLS delays a stream by seconds: it ships whole segments, and a player buffers several before it starts. RTSP carries each frame as it leaves the encoder, which measures about five times faster on the same content.
