...
// parsing (shared free functions in PinList.h, used by RmtLedDriver and I80Peripheral
...
// I80Peripheral::tick() is. So the host can pin only the reachable contract:
